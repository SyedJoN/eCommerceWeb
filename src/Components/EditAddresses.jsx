...
import { updateAvatar, updateProfile, getAddresses, updateAddress, fetchCountries } from "../store/authSlice";
...
function EditAddresses() {
    ...
    const submit = (e) => {
        ...
        const hasEmptyField = allAddresses.some((address) => {
            const userData = {
            ...
            // Check for empty fields in userData
            const emptyFields = Object.values(userData).some((value) => !value);
            return emptyFields;
        });
    
        if (hasEmptyField) {
            setError('Error! Fill all the fields to continue.');
            return;
        }
    
        // Proceed with dispatch if no empty fields
        allAddresses?.forEach((address) => {
            ...
            dispatch(
                ...
                } else if (status.meta.requestStatus === 'fulfilled') {
            ...
            <form onSubmit={submit}>
                <div className="space-y-12">
                    ...
                    <div className="border-b border-gray-900/10 pb-12">
                        <h2 className="text-base font-semibold leading-7 text-gray-900">Edit Addresses</h2>
                        ...
                        <div className="w-full max-w-md mt-3">
                            {allAddresses?.map((address, index) => (
                                <div key={index} className="mb-2">
                                    ...
                                    <div
                                        className={`overflow-hidden transition-max-height duration-300 ${activeIndex === index ? 'max-h-[610px]' : 'max-h-0'
                                            }`}
                                    >
                                        <div className="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                                            <div className="sm:col-span-3">
                                                ...
                                                <div className="mt-2">
                                                    <input type="text" name="addressLine1" id="addressLine1" autoComplete="family-name" value={address.addressLine1} onChange={(e) => handleInputChange(index, 'addressLine1', e.target.value)} className="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" />
                                            ...
                                            <div className="sm:col-span-3">
                                                ...
                                                <div className="mt-2">
                                                    <input type="text" value={address.addressLine2} onChange={(e) => handleInputChange(index, 'addressLine2', e.target.value)} name="addressLine2" id="addressLine2" className="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" />
                                                </div>
                                            </div>
                                            ...
                                            <div className="sm:col-span-3">
                                                ...
                                                <div className="mt-2">
                                                    <select id="country" value={address.country} onChange={(e) => handleInputChange(index, 'country', e.target.value)} className="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:max-w-xs sm:text-sm sm:leading-6">
                                            ...
                                            <div className="sm:col-span-2 sm:col-start-1">
                                                ...
                                                <div className="mt-2">
                                                    <input type="text" value={address.city} onChange={(e) => handleInputChange(index, 'city', e.target.value)} name="last-name" id="last-name" className="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" />
                                                </div>
                                            </div>
                                            ...
                                            <div className="sm:col-span-2">
                                                ...
                                                <div className="mt-2">
                                                    <input type="text" value={address.state} onChange={(e) => handleInputChange(index, 'state', e.target.value)} name="last-name" id="last-name" className="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" />
                                                </div>
                                            </div>
                                            ...
                                            <div className="sm:col-span-2">
                                                ...
                                                <div className="mt-2">
                                                    <input type="text" maxLength={6} value={address.pincode} onChange={(e) => handleInputChange(index, 'pincode', e.target.value)} name="last-name" id="last-name" className="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" />
                                                </div>
            ...
            <div className="flex flex-wrap justify-center mt-2">
                <div className="mx-auto w-[300px] rounded-md border">
                    <img
                        ...
                        alt="userAvatar"
                        className="relative h-44 w-full rounded-t-md object-cover"
                    />
                    <label htmlFor="avatarInput" className="custom-file-upload">Change Avatar
                        <Input
                            id="avatarInput"
                            type="file"
                    ...
                    <div className="p-4">
                        <form onSubmit={submit}>
                            ...
                            <h6 className="text-md flex font-semibold mt-3 ">FirstName:
                                <input type="text" className='text-black px-3 rounded-lg bg-white outline-none focus:bg-gray-50 duration-200 border border-gray-200 w-full ml-1'
                                    value={firstName}
                                    onChange={(e) => {
                            ...
                            <h6 className="text-md flex font-semibold mt-3 ">LastName:
                            ...
                            <h6 className="text-md flex font-semibold mt-3 ">PhoneNo:
                                <select className='rounded-md ml-1' defaultValue={countryCode} onChange={(e) => { setCountryCode(e.target.value) }}>
