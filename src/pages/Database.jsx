...
import { SideBar as SideBarComponent, UserProfile } from '../Components';
...
function Database() {
  ...
  return (
    <div className=' text-black flex border-t-2 border-black'>
      ...
      <div className="flex flex-wrap justify-center mt-2">
                <div className="mx-auto w-[300px] rounded-md border">
                    ...
                    <div className="p-4">
                        <h6 className="text-lg font-semibold">E-mail:  <span className='font-light'>{currentUser.data.email}</span></h6>
                        <h6 className="text-lg font-semibold mt-3 ">FirstName:  <span className='font-light'>{userProfile.firstName}</span></h6>

                        <h6 className="text-lg font-semibold mt-3 ">LastName:  <span className='font-light'>{userProfile.lastName}</span></h6>

                        <h6 className="mt-3 font-semibold">Phone Number: <span className='font-light'>{userProfile.countryCode + ' ' + userProfile.phoneNumber}</span></h6>
                        ...
                        <Link to={`/user/${currentUser.data._id}/addresses/edit`}>
